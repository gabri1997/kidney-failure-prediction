...
from big_nephro_dataset import YAML10YBiosDatasetFluoNotDecoupled
...
class NefroNet():
    def __init__(self, years, net, preprocess_type, num_classes, num_epochs, l_r, batch_size, n_workers, job_id, weights):
        # Hyper-parameters
        self.years = years
        self.net = net
    ...
    #FLUO
        ...
        dataset = YAML10YBiosDatasetFluo(dataset=dname, crop_type=dataset_type, transforms=custom_training_transforms_fluo, augmentation_transform = None, fluo_transform=fluo_norm, split=['training'])
        ...
        test_dataset = YAML10YBiosDatasetFluo(dataset=dname, crop_type=dataset_type, transforms=inference_transforms_fluo, fluo_transform=fluo_norm, augmentation_transform = None, split=['test'])
...
if __name__ == '__main__':
    ...
    n = NefroNet(years=5, net=opt.network, preprocess_type=opt.preprocess, num_classes=opt.classes, num_epochs=opt.epochs, batch_size=opt.batch_size,
